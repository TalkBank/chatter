//! CI guardrail for public docs that describe the current `chatter` surface.
//!
//! Checks that user-facing documentation does not reference removed CLI flags,
//! retired commands, or maintainer-local paths.
...
const BANNED_PATTERNS: &[BannedPattern] = &[
    ...
    BannedPattern {
        ...
        reason: "private archive path should not appear in public user or integrator docs",
    },
    BannedPattern {
