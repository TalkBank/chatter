...
This is an error-level invalidity diagnostic. Unsupported SES values are preserved in the model for roundtrip fidelity; preservation does not make them valid.
