...
This is an error-level invalidity diagnostic. Unsupported sex values are preserved in the model for roundtrip fidelity; preservation does not make them valid.
