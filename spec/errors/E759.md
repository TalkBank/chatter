...
[[example]]
title = 'An unclosed leading retrace still has no host'
level = 'utterance'
claim = { subsumed_by = 'E312' }
notes = 'Recovery retains an opening-bracket fragment with no closer; the shared UnclosedDelimiter classifier owns that narrower fault before a whole postfix annotation can be admitted.'
chat = '''
@UTF8
@Begin
@Languages:	eng
...
[[example]]
title = 'A retrace after its word has a host'
level = 'utterance'
claim = 'legal'
chat = '''
@UTF8
...
[[example]]
title = 'An unclosed retrace after a word retains fragmented recovery'
level = 'utterance'
claim = { subsumed_by = 'E375' }
notes = 'The ERROR fragment is a space plus opening bracket, not a whole retrace token. The bracket-fragment diagnostic applies; this does not claim a complete postfix annotation at utterance start.'
chat = '''
@UTF8
@Begin
@Languages:	eng
