...
- **Recovery and locations**: Both participants remain available in the
  recovered model. File parsing and header-fragment parsing report the
  diagnostic at the trailing comma, including the caller's fragment offset.
  The legal control omits only that final comma and must remain accepted.
