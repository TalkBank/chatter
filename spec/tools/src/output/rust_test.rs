...
pub fn generate_construct_test_body(specs: &[ConstructSpec], test_error_path: &str) -> String {
    ...
    output.push_str("// DO NOT EDIT MANUALLY - regenerate from chatter spec/ via `make test-gen`\n\n");
...
mod tests {
    ...
    fn test_generate_construct_test() {
        ...
        let output =
            generate_construct_test(&example, "word", "talkbank_parser_tests::test_error::TestError");
