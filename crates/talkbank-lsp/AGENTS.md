...
Guidance for coding agents working inside `crates/talkbank-lsp/`. Read the
workspace-level `AGENTS.md` (at the chatter repo root) first; this file layers
**LSP-specific rules** on top of the cross-cutting design rules.

**Cross-ref (root `AGENTS.md` "CST Traversal Rules"):** the LSP consumes
