...
/// Schema version currently emitted. Matches the TalkBank XML golden
...
pub(super) struct XmlEmitter {
    ...
    /// document. TalkBank XML assigns these in encounter order.
...
/// escaping: only `<`, `>`, `&` are replaced. TalkBank XML writes
