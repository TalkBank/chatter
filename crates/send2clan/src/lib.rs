...
//! # Start here
//!
//! - [`send_to_clan`] is the primary entry point
//! - [`is_platform_supported`] and [`is_clan_available`] let callers check
//!   whether the current machine can use the integration before attempting it
//! - [`Error`] and [`Result`] define the typed failure surface
//!
...
pub use api::{
    OPEN_LOCATION_TIMEOUT_SECS, get_capabilities, is_clan_available, is_platform_supported,
