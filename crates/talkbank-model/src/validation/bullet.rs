...
// Cross-speaker bullet overlap (CLAN Error 84, the `+c0` strict-timeline mode)
// is intentionally not validated; see the module docs in validation::temporal
// for why it is excluded from default validation.
