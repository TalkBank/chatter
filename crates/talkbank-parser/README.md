...
[tree-sitter-talkbank](https://crates.io/crates/tree-sitter-talkbank) grammar
crate from the same repository to produce a concrete syntax tree (CST), then
converts it into the model's abstract types.
